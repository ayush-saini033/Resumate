            ...
            <div key={exp.id} className="mb-6">
              <div className="flex justify-between mb-2">
                <div>
                  ...
                  <p className="italic text-gray-600 text-sm">{exp.title}</p>
                </div>
      ...
      {resumeInfo.education?.length > 0 && (
        <section className="mb-10">
          ...
          {resumeInfo.education.map((edu) => (
            <div key={edu.id} className="mb-5 flex justify-between items-start">
              <div>
                <h3 className="font-semibold text-lg">{edu.universityName}</h3>
